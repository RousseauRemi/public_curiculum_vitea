      ...
      <div className="px-2 py-4 flex items-center justify-between w-full">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-secondary">{language === Language.FR ? 'Ingénieur .NET senior' : 'Senior .NET Engineer'}</p>
          </div>
        </motion.div>
        ...
        <div className="flex items-center gap-1">
          <motion.button
            ...
            className="p-2 rounded-lg text-secondary hover:bg-secondary hover:text-primary transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
