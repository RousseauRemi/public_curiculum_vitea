...
export const MobileNavigation: React.FC<MobileNavigationProps> = ({
  ...
  const { language, isMobileMenuOpen, setLanguage, setMobileMenuOpen, theme, toggleTheme } = useAppStore();
  ...
  return (
    <>
      <motion.nav 
        ...
        className="flex lg:hidden fixed top-0 left-0 right-0 bg-white shadow-card z-50 border-b border-secondary-200 px-4"
        initial={{ y: -80 }}
        animate={{ y: 0 }}
